    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 pt-20">
      ...
      <div className="relative w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold font-[family-name:var(--font-display)]">Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <Link href="/reset" className="text-xs text-brand-400 hover:text-brand-300">Forgot password?</Link>
            </div>
            <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••" className="mt-2" />
          </div>
        ...
        <p className="mt-6 text-center text-sm text-white/50">
          ...
          <Link href="/signup" className="font-medium text-brand-400 hover:text-brand-300">Sign up</Link>
        </p>

        <div className="mt-4 rounded-xl border border-white/10 bg-white/5 p-3">
          <p className="text-xs text-white/40">Demo: demo@komputeks.com / password123</p>
        </div>
      </div>
    </div>
  );
