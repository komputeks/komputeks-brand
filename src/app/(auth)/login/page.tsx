    ...
    <div className="relative min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold font-display">Welcome back</h1>
        ...
        <p className="mt-6 text-center text-sm text-white/60">
          ...
          <Link href="/signup" className="font-medium text-brand-400 hover:text-brand-300 transition-all duration-300">Sign up</Link>
        </p>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center pt-20"><div className="animate-spin h-8 w-8 border-2 border-brand-400 border-t-transparent rounded-full" /></div>}>
      <LoginForm />
    </Suspense>
  );
}