      ...
      <div className="mt-8">
        <Card className="p-6">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <a href="/products" className="rounded-xl bg-brand-500/10 border border-brand-500/20 px-4 py-3 text-sm font-medium text-brand-400 hover:bg-brand-500/20 transition-all duration-300">
              Browse Products →
            </a>
            <a href="/docs" className="rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-sm font-medium text-white/60 hover:bg-white/10 hover:text-white transition-all duration-300">
              Read Documentation →
            </a>
          </div>
        </Card>
