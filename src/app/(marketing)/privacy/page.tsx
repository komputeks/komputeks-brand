...
export const metadata: Metadata = {
  ...
  description: 'Komputeks privacy policy — how we collect, use, and protect your data.',
};
  ...
  return (
    <div className="pt-28 pb-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl dark:text-white">Privacy Policy</h1>
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">3. Data Storage</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">4. Third-Party Services</h2>
