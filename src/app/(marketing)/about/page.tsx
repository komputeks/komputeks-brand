      ...
      <div className="relative z-10 pt-28 pb-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {['Built from a phone', 'Learned from free resources', 'Rebuilt after failure', 'Operated with almost no capital'].map((item) => (
              <div key={item} className="glass-card p-6">
                ...
                <p className="mt-1 text-sm gradient-text">We have.</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-16 mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="glass-card p-6 text-left">
                <p className="text-sm text-white/40">As software becomes free...</p>
                <p className="mt-1 text-lg font-semibold gradient-text">Guidance becomes valuable</p>
              </div>
              <div className="glass-card p-6 text-left">
                <p className="text-sm text-white/40">As code becomes abundant...</p>
          ...
          <div className="mt-16 glass-card p-8">
            ...
            <div className="mt-8 rounded-2xl border border-brand-500/20 bg-brand-500/10 p-6">
