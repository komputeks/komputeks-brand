...
export function LandingTestimonials({ testimonials }: { testimonials: Testimonial[] }) {
  return (
    <section className="relative z-10 border-y border-white/10 bg-surface-900/50 py-20">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="mb-12 text-center text-3xl font-bold font-display tracking-tight">
          What People Say
        </h2>
