    ...
    <section className="relative border-y border-white/10 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-3xl font-bold tracking-tight text-white">The Three Pillars</h2>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {pillars.map(({ icon: Icon, title, description, gradient }) => (
            <div key={title} className="glass-card p-8">
              <div className={cn('mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br', gradient)}>
