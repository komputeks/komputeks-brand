  ...
  return (
    <div className="pt-28 pb-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl dark:text-white">Terms of Service</h1>
        <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-500">Last updated: June 2025</p>
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">1. Acceptance</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">2. Description of Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">3. User Accounts</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">4. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">5. Free Tier</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-white">7. Limitation of Liability</h2>
