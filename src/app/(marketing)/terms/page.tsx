...
export const metadata: Metadata = {
  ...
  description: 'Komputeks terms of service.',
};
    ...
    <div className="relative overflow-hidden pt-28 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-white/60">
          ...
          <section className="glass-card p-6">
            <h2 className="text-lg font-semibold font-display">4. Acceptable Use</h2>
          ...
          <section className="glass-card p-6">
            <h2 className="text-lg font-semibold font-display">5. Free Tier</h2>
          ...
          <section className="glass-card p-6">
            <h2 className="text-lg font-semibold font-display">6. Intellectual Property</h2>
          ...
          <section className="glass-card p-6">
            <h2 className="text-lg font-semibold font-display">7. Limitation of Liability</h2>
          ...
          <section className="glass-card p-6">
            <h2 className="text-lg font-semibold font-display">8. Contact</h2>
