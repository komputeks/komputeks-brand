...
export const metadata: Metadata = {
  title: 'Roadmap',
  description: 'Upcoming features and growth experiments.',
};

const roadmap = [
  {
    phase: 'Now',
    items: ['Launch brand website with all marketing pages', 'Supabase auth with email and Google OAuth', 'Admin dashboard for content management', 'PWA support for mobile installation', 'SEO optimization for discoverability'],
  },
  {
    phase: 'Next',
    items: ['Blog system with rich text editor', 'Product-specific documentation pages', 'Email notification system for subscribers', 'Google Knowledge Panel optimization', 'Social media integration'],
  },
  {
    phase: 'Future',
    items: ['Komputeks AI chatbot integration', 'Community forum / discussion board', 'Referral and invite flow', 'Android TWA / APK generation', 'Analytics dashboard for admin', 'Multi-language support'],
  },
];
