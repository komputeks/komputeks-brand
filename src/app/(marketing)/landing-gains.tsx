  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="font-display text-3xl font-bold tracking-tight text-white">What You Gain</h2>
        <p className="mt-3 text-white/60">They charge you for these, but we give you FREE.</p>
      </div>
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {gains.map((gain) => (
          <div key={gain.title} className="glass-card p-6 transition-all duration-300 hover:bg-white/10">
            <h3 className="font-display text-lg font-semibold text-white">{gain.title}</h3>
